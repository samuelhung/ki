...
EXPECTED_ROUTE_ORDER = [
    ...
    ("IncludedRouter", "transcript_router"),
...
EXPECTED_OPENAPI_OPERATIONS = [
    ...
    ("/api/events/{event_id}/transcript", "get", "get_transcript_api_events__event_id__transcript_get"),
    ("/api/events/{event_id}/transcript/revisions/{revision_id}", "get", "get_revision_api_events__event_id__transcript_revisions__revision_id__get"),
    ("/api/events/{event_id}/transcript/manual", "put", "save_manual_api_events__event_id__transcript_manual_put"),
    ("/api/events/{event_id}/transcript/segment", "post", "start_segmentation_api_events__event_id__transcript_segment_post"),
    ("/api/events/{event_id}/transcript/segment/{task_id}", "get", "get_segmentation_status_api_events__event_id__transcript_segment__task_id__get"),
    ("/api/events/{event_id}/transcript/segment/{task_id}/confirm", "post", "confirm_segmentation_api_events__event_id__transcript_segment__task_id__confirm_post"),
    ("/api/events/{event_id}/transcript/revisions/{revision_id}/restore", "post", "restore_revision_api_events__event_id__transcript_revisions__revision_id__restore_post"),
