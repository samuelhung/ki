...
└── Python / FastAPI 后端
    ...
    │   ├── 远程请求使用 Bearer / X-API-Key，浏览器令牌仅保留在当前会话
...
export const CORE_MODULES = [
  { name: '今日知几', desc: '每日总览入口，聚合指标、热力图、AI 运转状态和最近内容' },
  { name: '万象资料', desc: '资料输入与内容资产库，承载内容采集、事件列表、信息源和上传队列' },
  { name: '深度研究', desc: '把资料组织成结构，整合专题系列、知识图谱和产业链研究' },
  { name: '静观思辨', desc: '围绕问题做慢思考，承载头脑风暴、多轮追问和概念沉淀' },
  { name: '见微行动', desc: '把理解转成下一步动作，承载待办事务、综合事务和 AI 判断' },
  { name: '启蒙辅导', desc: '独立学习场景，支持教材 PDF、逐课解读、孩子版/家长版/错题复盘' },
  { name: '系统总览', desc: '系统说明、数据流、版本更新、数据库、日志、设置和 API 文档入口' },
];
...
export const ARCHITECTURE_FEATURES = [
  ...
  { name: '远程访问认证', desc: '非回环请求使用 KI_API_TOKEN，浏览器访问令牌仅保存在当前标签会话并随 Authorization 请求头发送' },
