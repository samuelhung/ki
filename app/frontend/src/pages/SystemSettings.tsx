...
function NumberInput({ label, value, onChange, min = 0, max = 2, step = 0.1, hint }: {
...
function TaskRow({ name, cnName, config, suggestion, onChange }: {
...
function PromptSection({ moduleKey }: { moduleKey: string }) {
  ...
  const taskNames = TASK_NAMES[moduleKey] || {};
