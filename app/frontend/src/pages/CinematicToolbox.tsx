  ...
  return (
    <section className="ingest-detail-reader toolbox-detail-reader" aria-label="计算详情">
      ...
      <div className="detail-scroll-shell"><div className="detail-scroll toolbox-detail-body">
        ...
        <div className="toolbox-input-grid"><Field label="贷款金额（元）" value={props.principal} onChange={props.setPrincipal} /><Field label="还款年限" value={props.years} onChange={props.setYears} hint={`${props.periods} 期（月）`} />
